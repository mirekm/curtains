...
test = () ->
    ...
    actor = new curtains.CssActor 1, '#actor2', {'border-radius': 0}
    ...
    we = new curtains.CssActor 1, '#actor3_we', {left: 25}, 'Actor03 We'
    mirumee.dropOnStage we, 1, 20
    mirumee.tweenActor we, 'left', 0, 1, 20

    build = new curtains.CssActor 1, '#actor3_build', {left: 50}, 'Actor03 Build'
    mirumee.dropOnStage build, 1, 20
    mirumee.tweenActor build, 'left', 32, 1, 20

    webapps = new curtains.CssActor 1, '#actor3_webapps', {left: 75}, 'Actor03 WebApps'
    mirumee.dropOnStage webapps, 1, 20
    mirumee.tweenActor webapps, 'left', 85, 1, 20

    better = new curtains.CssActor 1, '#actor3_better', {left: 200}, 'Actor03 Better'
    mirumee.dropOnStage better, 1, 20
    mirumee.tweenActor better, 'left', 175, 1, 20

    theatre.addKeyframe 100, () =>
